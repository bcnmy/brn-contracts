...
abstract contract TATransactionAllocationStorage {
    ...
    struct TAStorage {
        mapping(EpochId => mapping(RelayerAddress => uint256 transactionsSubmitted)) transactionsSubmitted;
        mapping(EpochId => uint256 totalTransactionsSubmitted) totalTransactionsSubmitted;
        mapping(EpochId => bool processed) livenessCheckProcessed;
    }
